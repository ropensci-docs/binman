...
- Fixed a bug in an assertion function (thanks
  [@vjcitn](https://github.com/vjcitn)
  [\#6](https://github.com/ropensci/binman/issues/6))
...
- “binman\_” is now prepended to the root directory of an app to prevent
  possible name clashes.
- Add bzip2 file format to unziptar_dlfiles

## binman 0.0.4

- Added list_versions function, docs and test to list application
  version by platform.
- Added rm_version function, docs and test to remove application
  versions by platform.
- Added rm_platform function, docs and test to remove application by
  platform.
